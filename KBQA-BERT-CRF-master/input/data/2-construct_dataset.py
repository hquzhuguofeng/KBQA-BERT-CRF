...
for file_name in file_name_list:
        ...
        for line in f:
            ...
            if start_str in line:  # new question answer triple
                ...
                if entities in q_str:
                    ...
                    tag_start_index = q_str.find(entities) # 找到实体在问题中的位置
                    
                    for i in range(tag_start_index, tag_start_index + len(entities)): # 将问题中的实体标记起来
    ...
    # >>> seq_result[0:10]
    # ['《 O', '机 B-LOC', '械 I-LOC', '设 I-LOC', '计 I-LOC', '基 I-LOC', '础 I-LOC', '》 O', '这 O', '本 O']
