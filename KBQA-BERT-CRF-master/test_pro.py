...
def select_database(sql):
    # connect database
    connect = pymysql.connect(user="root",password="root",host="127.0.0.1",port=3306,db="kb_qa",charset="utf8")
...
def main():
    ...
    if attribute != '' and answer != '':
        ...
        sim_model.eval()
        attribute_idx = semantic_matching(sim_model,tokenizer,sent,attribute_list,answer_list,64).item()
